...
### **Part1: common to all analysis, produce the `read_info.txt` file**
...
### **Part2: Produce high resolution map of interactions**
...
### **Part3: Produce map of sister nucleosome ligation**
